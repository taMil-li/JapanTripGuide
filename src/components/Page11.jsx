...
import vittaemoneyLogo from "../assets/vittaemoneylogo3.jpeg";

function Page11() {
  return (
    <div className="page-11 page-12 page">
            ...
            <div className="first">
              <fieldset className="fieldset d-flex flex-column">
                <div>
                  ...
                  <p className="para">
                    Try Shojin Ryori for vegetarian/vegan Michelin-quality
                    meals.
                    <br /> <br />
                    Lunch at Michelin-starred restaurants (Ginza Kojyu, Sushi
                    Saito, Narisawa) costs 50-70% less than dinner with same
                    food.
                  </p>
                  <br />
                  ...
                  <p className="para">
                    Use Yamato Transport to ship luggage overnight (~680 per
                    bag) for travelling hands-free on Shinkansen Green Car.
                    <br /> <br /> Buy JR Pass for unlimited national train
                    travel.
                    <br /> <br /> Book tickets via Klook or Rakuten Travel to
                    avoid OTP issues.
                    <br /> <br /> Transfer credit card points to airlines for
                    ANA flights.
                    <br /> <br /> If you only stay in one city, a local IC card
                    (like Suica/Pasmo) would be much cheaper (approx. ₹7,000 -
                    ₹10,000).
                    <br /> <br /> Withdraw Yen at 7-Eleven ATMs for Better
                    Forex. Show Indian passport at stores like Isetan/Daimaru
                    for 5% discount.
                    <br /> <br /> Purchases over ¥5,500 get 10% instant tax
                    refund (~15% total savings).
                ...
                <div
                  ...
                  className="logo-part d-flex flex-column align-items-center justify-content-center"
                >
